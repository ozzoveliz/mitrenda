 ...
 */
class Onetree_Sales_Block_Adminhtml_Sales_Invoice_Gridcsv2 extends Mage_Adminhtml_Block_Sales_Invoice_Grid
{
...
//        $this->setId('sales_invoice_grid');
    ...
    protected function _prepareCollection()
    {
        ...
        $filter_id = explode(",",$this->getRequest()->getParam('internal_invoice_ids',false));
...
//        Mage::log($collection->getSelect()->__toString());
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('concepto', array(
            ...
            'type'      => 'text',
            'width'     => '20%',
            'renderer' => new Onetree_Sales_Model_Renderer_Concepto()
        ));
...
//            'currency'  => 'order_currency_code',
            'renderer' => new Onetree_Sales_Model_Renderer_Currency()
        ));
        ...
        $this->addColumn('iva', array(
            ...
            'type'      => 'currency',
            'align'     => 'right',
            'renderer' => new Onetree_Sales_Model_Renderer_Iva()
        ));
