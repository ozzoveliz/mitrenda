...
//        $button_sync_info = $this->getLayout()->createBlock('adminhtml/widget_button','',array(
//            'type'  =>  'button',
//            'label' =>  Mage::helper('pdfinvoiceplus')->__('Update infomation'),
//            'onclick' => 'updateInfomation('.$data['template_id'].')'
//        ));
//        $fieldset->addField('update_infomation','note',array(
//            'text'  =>  $button_sync_info->toHtml(),
//            'after_element_html' => '<br/>'.Mage::helper('pdfinvoiceplus')->__('Update these infomations to template Order, Invoice, Creditmemo')
//        ));
