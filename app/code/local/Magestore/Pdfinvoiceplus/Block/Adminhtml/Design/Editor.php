...
class Magestore_Pdfinvoiceplus_Block_Adminhtml_Design_Editor extends Mage_Core_Block_Template
{
    ...
    public function getBackUrl(){
        ...
        if($type == 'order')
            return Mage::getSingleton('adminhtml/url')->getUrl('pdfinvoiceplus/adminhtml_design/editOrder', array('id'=>$id));
        elseif($type == 'invoice')
            return Mage::getSingleton('adminhtml/url')->getUrl('pdfinvoiceplus/adminhtml_design/editInvoice', array('id'=>$id));
        elseif($type == 'creditmemo')
            return Mage::getSingleton('adminhtml/url')->getUrl('pdfinvoiceplus/adminhtml_design/editCreditmemo', array('id'=>$id));
    }
