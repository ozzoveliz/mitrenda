...
class Magestore_Pdfinvoiceplus_Adminhtml_SyncInfoController extends Mage_Adminhtml_Controller_Action {
    ...
    public function updateAction() {
        ...
        switch ($type){
            case 'order':
                $this->_redirect('pdfinvoiceplus/adminhtml_design/editOrder', array('id' => $id));
                return;
            case 'invoice':
                $this->_redirect('pdfinvoiceplus/adminhtml_design/editInvoice', array('id' => $id));
                return;
            case 'creditmemo':
                $this->_redirect('pdfinvoiceplus/adminhtml_design/editCreditmemo', array('id' => $id));
                return;
            default:
                return;
        }
