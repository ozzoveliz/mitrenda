...
class Magestore_Pdfinvoiceplus_Model_Sales_Order_Creditmemo extends Mage_Sales_Model_Order_Creditmemo
{
    /**
    ...
    public function sendEmail($notifyCustomer = true, $comment = '')
    {
        ...
        if($isAttach){
            if(Mage::helper('pdfinvoiceplus/pdf')->customPdfEnable()){
                ...
                $pdfFile = Mage::getSingleton('pdfinvoiceplus/entity_creditmemopdf')->getThePdf((int) $this->getId(), false);
